...
- **`generated/` is disposable** for items with a regeneration path (completions/functions/plugins/docs); `generated/bin/` currently contains non-regenerated artifacts.
...
3. **`generated/` is safe to delete (when regeneratable)**
   ...
   * `generated/docs/<hostname>/` stores host-specific snapshots (git-ignored).
...
| `generated/`                                   | Generated outputs (completions/functions/plugins/docs) + non-regenerated local bins      | Artifact (partially regen)  |
