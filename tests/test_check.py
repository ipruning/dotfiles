...
def test_inspect_host_reports_capabilities_and_their_invalid_transition(
    ...
    healthy = inspect_host(repo_root, home, executable_finder=finder)
    ...
    source.rmdir()
    degraded = inspect_host(repo_root, home, executable_finder=finder)
...
def test_inspect_host_reports_invalid_skillshare_yaml(tmp_path: Path) -> None:
    ...
    report = inspect_host(repo_root, home, executable_finder=lambda _command: None)
